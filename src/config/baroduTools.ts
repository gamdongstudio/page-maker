...
export const BARODU_TOOLS = {
   ...
   */
  installerUrl: 'https://github.com/gamdongstudio/barodu-tools/releases/download/v1.0.15/PM-Connect-Setup-1.0.15.exe',

  /** 설치파일 이름 — 주소가 없을 때 어디를 찾으면 되는지 알려주기 위해 */
  installerFileName: 'PM-Connect-Setup-1.0.15.exe',
